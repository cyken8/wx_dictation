...
public class SpeechUtil {
  ...
  public static final String APP_ID = "16063771";

  public static final String API_KEY = "5RRe9TfDwH3G08yuRVkcDYIR";

  public static final String SECRET_KEY = "sEEWiM7ITVZvNhzrbeEEXmnhGa1kOwBG";

    private static AipSpeech client;

    public static void main(String[] args) throws IOException {
        SpeechSynthesizer("简单测试百度语音合成", "f:/SpeechSynthesizer.mp3");
        convertMP32Pcm("f:/SpeechSynthesizer.mp3","f:/SpeechSynthesizer.pcm");
        SpeechRecognition("f:/SpeechSynthesizer.pcm","pcm");
...
//        client.setSocketProxy("proxy_host", proxy_port);  // 设置socket代理
     ...
     * @return
     */
    public static String SpeechRecognition2(String videoPath, String videoType) {
        // 初始化一个AipSpeech
        client = getInstance();
...
//        client.setSocketProxy("proxy_host", proxy_port);  // 设置socket代理
	    ...
	    if(null!=res&&res.getInt("err_no")==0) {
	    	return res.getJSONArray("result").get(0).toString().split(",")[0];
