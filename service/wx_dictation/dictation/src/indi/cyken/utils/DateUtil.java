...
public class DateUtil {
     ...
     * @return Timestamp
     */
    public static Timestamp strToTimestampLong(String strDate) {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        //ParsePosition pos = new ParsePosition(0);
        Timestamp ts=null;
        Date strtodate;
		try {
	        ...
	        ts=new Timestamp(strtodate.getTime());
	        return ts;
     ...
     * @return
     */
    public static String getPreTimeM(String sj1, String jj) {
     ...
     * @return
     */
    public static String getPreTimeS(String sj1, String jj) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String mydate1 = "";
        try {
            Date date1 = format.parse(sj1);
     ...
     * @return
     */
    public static String getPreTimeS(String sj1, Integer jj) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String mydate1 = "";
        try {
            Date date1 = format.parse(sj1);
     ...
     * @return
     */
    public static String getPreTimeS(Date sj1, Integer jj) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String mydate1 = "";
        try {
            Date date1 = sj1;
